    ...
    public void Init(ENDSCREEN_TYPE type)
    {
        ...
        switch (chosenType)
        {
            case ENDSCREEN_TYPE.MR_X:
                ...
                text.text = "Vous n’avez plus le choix : le masque qui vous est tendu est le votre. Le mettre vous ouvre les yeux et toute cette course-poursuite vous semble être une perte de temps. Ce qu’il vous faut maintenant, c’est de continuer les courses.Toujours plus de courses. Pour toujours.";
